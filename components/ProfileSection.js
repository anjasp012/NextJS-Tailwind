  ...
  return (
    <section className="py-32" id="profile">
      <div className="container mx-auto px-10 2xl:px-0">
        ...
        <div className="flex flex-wrap xl:w-9/12 lg:items-center md:items-start mx-auto mt-12">
          <div className="md:w-5/12 w-full px-14 mb-8 md:mb-0">
            <img src="/profile.png" className="w-full" alt="" />
          </div>
          <div className="md:w-7/12 w-full px-8">
